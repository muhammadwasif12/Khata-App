...
/// Displays all customers for the active business with search and balance info.
...
class _CustomerListScreenState extends ConsumerState<CustomerListScreen> {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return PartyListTile(
                        ...
                        balance: balance,
                        isCredit: isCredit,
                        onTap: () => context.push('/home/customers/ledger/${party.id}'),
                        onEdit: () => context.push('/home/customers/edit/${party.id}'),
  ...
  void _confirmDelete(PartyEntity party) {
    showConfirmationDialog(
      ...
      onConfirm: () {
        ref.read(customersProvider.notifier).deleteParty(party.id);
      },
    );
  }
}
