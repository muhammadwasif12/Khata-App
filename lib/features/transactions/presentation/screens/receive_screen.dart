/// Receive Screen — Full page for recording "لیا" (received / money collected)
/// Mirrors GiveScreen but uses green/credit theme and txnType.debit.
...
class ReceiveScreen extends ConsumerStatefulWidget {
  ...
  const ReceiveScreen({super.key, required this.partyId});
                      ...
                      decoration: InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(
                          ...
                          borderSide: const BorderSide(
                              color: AppColors.credit, width: 2),
                        ),
                      ),
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: IconButton(
                      icon: const Icon(Icons.calculate_outlined,
                          color: AppColors.credit, size: 28),
                      tooltip: 'حساب',
              ...
              Wrap(
                ...
                children: TransactionEntity.paymentMethods.map((method) {
                  ...
                  return ChoiceChip(
                    ...
                    side: BorderSide(
                      color:
                          isSelected ? AppColors.credit : AppColors.divider,
                    ),
                    onSelected: (_) =>
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12),
                    borderSide:
                        const BorderSide(color: AppColors.credit, width: 2),
                  ),
                ),
                style: const TextStyle(fontFamily: AppTextStyles.urduFont),
              ),
